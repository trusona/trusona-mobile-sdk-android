...
1. Define the SDK version you wish to use and add the `implementation` dependency to your Gradle project.

```gradle
dependencies {
  // other dependencies
  implementation "com.trusona.android:mobile-sdk:6.6.0"

  // the following is only required if you will be using the Trusona Passport SDK
  //implementation "com.trusona.android:passport-sdk:6.6.0"
}
```
